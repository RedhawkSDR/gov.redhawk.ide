...
public class $editorClassName$ extends AbstractScaContentEditor<ScaComponent> {
	...
	private void createControlGroup(Composite parent) {
		...
		if (input instanceof ScaComponent) {
			ScaComponent component = (ScaComponent) input;
			Resource resource = component.getObj();
	...
	public void setSelection(ISelection selection) {
		if (selection instanceof IStructuredSelection) {
			...
			if (!sel.isEmpty()) {
				if (sel.getFirstElement() instanceof ScaComponent) {
					ScaComponent component = (ScaComponent) sel.getFirstElement();
