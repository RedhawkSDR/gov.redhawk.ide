...
public class MFileParser implements MFileParserConstants {
  ...
  final public MFile mFile() throws ParseException {MFile retVal = new MFile();
  Function function;
    label_1:
    while (true) {
      switch (jj_nt.kind) {
...
{if ("" != null) return retVal;}
  ...
  final public List < String > outputs() throws ParseException {List < String > strList = new ArrayList < String > ();
  String id = null;
    switch (jj_nt.kind) {
    case 12:{
      jj_consume_token(12);
...
{if ("" != null) return strList;}
  ...
  final public Function function() throws ParseException {Function function = new Function();
...
{if ("" != null) return function;}
  ...
  final public void functionArgs(Function function, List < String > strList) throws ParseException {String param;
    jj_consume_token(15);
    label_2:
    while (true) {
      switch (jj_nt.kind) {
...
function.getInputDefaultValues().put(input, Double.valueOf(token.image));
  ...
  final public List < String > multiPart() throws ParseException {List < String > retVal = new ArrayList < String > ();
    jj_consume_token(ID);
  ...
  private boolean jj_3R_9()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80000,0x800,0x100000,0x101000,0x100000,0x8000,0x80000,0x100000,0x4000,0x10000,0x80000,0x40000,0x3e00000,0x110000,0x10000,};
   }
