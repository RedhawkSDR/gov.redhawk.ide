...
public class TopLevelSadRpmSpecTemplate
{
  ...
  protected final String TEXT_8 = NL + "Release: 1%{?dist}" + NL + "License: None" + NL + "Group: REDHAWK/Waveforms" + NL + "Source: %{name}-%{version}.tar.gz" + NL + "" + NL + "# Require the controller whose SPD is referenced" + NL + "Requires: ";
  protected final String TEXT_9 = NL + NL + "# Require each referenced component" + NL + "Requires:";
  protected final String TEXT_10 = " ";
  protected final String TEXT_11 = NL + NL + "BuildArch: noarch" + NL + "BuildRoot: %{_tmppath}/%{name}-%{version}" + NL + "" + NL + "%description";
