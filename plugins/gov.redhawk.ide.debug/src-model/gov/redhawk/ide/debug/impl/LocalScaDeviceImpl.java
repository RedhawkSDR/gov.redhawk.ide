 ...
 *   <li>{@link gov.redhawk.ide.debug.impl.LocalScaDeviceImpl#getExecParams <em>Exec Params</em>}</li>
...
public class LocalScaDeviceImpl extends ScaDeviceImpl<Device> implements LocalScaDevice {
	...
	public EList<String> getExecParams() {
		if (execParams == null) {
			execParams = new EDataTypeUniqueEList.Unsettable<String>(String.class, this, ScaDebugPackage.LOCAL_SCA_DEVICE__EXEC_PARAMS);
		}
		return execParams;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ScaDebugPackage.LOCAL_SCA_DEVICE__MODE:
				return getMode();
			case ScaDebugPackage.LOCAL_SCA_DEVICE__EXEC_PARAMS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == LocalLaunch.class) {
			switch (derivedFeatureID) {
				case ScaDebugPackage.LOCAL_SCA_DEVICE__LAUNCH: return ScaDebugPackage.LOCAL_LAUNCH__LAUNCH;
				case ScaDebugPackage.LOCAL_SCA_DEVICE__MODE: return ScaDebugPackage.LOCAL_LAUNCH__MODE;
				default: return -1;
			}
		}
		if (baseClass == LocalAbstractComponent.class) {
			switch (derivedFeatureID) {
				case ScaDebugPackage.LOCAL_SCA_DEVICE__EXEC_PARAMS: return ScaDebugPackage.LOCAL_ABSTRACT_COMPONENT__EXEC_PARAMS;
				case ScaDebugPackage.LOCAL_SCA_DEVICE__IMPLEMENTATION_ID: return ScaDebugPackage.LOCAL_ABSTRACT_COMPONENT__IMPLEMENTATION_ID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == LocalLaunch.class) {
			switch (baseFeatureID) {
				case ScaDebugPackage.LOCAL_LAUNCH__LAUNCH: return ScaDebugPackage.LOCAL_SCA_DEVICE__LAUNCH;
				case ScaDebugPackage.LOCAL_LAUNCH__MODE: return ScaDebugPackage.LOCAL_SCA_DEVICE__MODE;
				default: return -1;
			}
		}
		if (baseClass == LocalAbstractComponent.class) {
			switch (baseFeatureID) {
				case ScaDebugPackage.LOCAL_ABSTRACT_COMPONENT__EXEC_PARAMS: return ScaDebugPackage.LOCAL_SCA_DEVICE__EXEC_PARAMS;
				case ScaDebugPackage.LOCAL_ABSTRACT_COMPONENT__IMPLEMENTATION_ID: return ScaDebugPackage.LOCAL_SCA_DEVICE__IMPLEMENTATION_ID;
				default: return -1;
			}
		}
