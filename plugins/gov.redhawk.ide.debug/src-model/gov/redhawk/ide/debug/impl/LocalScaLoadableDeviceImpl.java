...
public class LocalScaLoadableDeviceImpl extends ScaLoadableDeviceImpl<LoadableDevice> implements LocalScaLoadableDevice {
	...
	public void setImplementationID(String newImplementationID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaDebugPackage.LOCAL_SCA_LOADABLE_DEVICE__IMPLEMENTATION_ID, oldImplementationID, implementationID));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == LocalLaunch.class) {
			switch (derivedFeatureID) {
				case ScaDebugPackage.LOCAL_SCA_LOADABLE_DEVICE__LAUNCH: return ScaDebugPackage.LOCAL_LAUNCH__LAUNCH;
				case ScaDebugPackage.LOCAL_SCA_LOADABLE_DEVICE__MODE: return ScaDebugPackage.LOCAL_LAUNCH__MODE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == LocalLaunch.class) {
			switch (baseFeatureID) {
				case ScaDebugPackage.LOCAL_LAUNCH__LAUNCH: return ScaDebugPackage.LOCAL_SCA_LOADABLE_DEVICE__LAUNCH;
				case ScaDebugPackage.LOCAL_LAUNCH__MODE: return ScaDebugPackage.LOCAL_SCA_LOADABLE_DEVICE__MODE;
				default: return -1;
			}
		}
		if (baseClass == LocalAbstractComponent.class) {
