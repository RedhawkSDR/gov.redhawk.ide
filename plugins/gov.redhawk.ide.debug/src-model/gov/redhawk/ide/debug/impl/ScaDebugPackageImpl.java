...
public class ScaDebugPackageImpl extends EPackageImpl implements ScaDebugPackage {
	 ...
	 * @generated
	 */
	private EClass sandboxOperationsEClass = null;
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EDataType attrSandboxOperationsEDataType = null;
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EDataType attrApplicationOperationsEDataType = null;
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EDataType attrDeviceManagerOperationsEDataType = null;
	 ...
	 * @generated
	 */
	public EReference getLocalScaWaveform_ComponentHost() {
	 ...
	 * @generated
	 */
	public EReference getLocalScaWaveform_ComponentHostDebug() {
		return (EReference) localScaWaveformEClass.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getLocalScaWaveform_LocalApp() {
		return (EAttribute) localScaWaveformEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getLocalScaWaveform_DomainWaveform() {
		return (EReference) localScaWaveformEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		createEReference(localScaWaveformEClass, LOCAL_SCA_WAVEFORM__COMPONENT_HOST);
		createEReference(localScaWaveformEClass, LOCAL_SCA_WAVEFORM__COMPONENT_HOST_DEBUG);
		createEAttribute(localScaWaveformEClass, LOCAL_SCA_WAVEFORM__LOCAL_APP);
		createEReference(localScaWaveformEClass, LOCAL_SCA_WAVEFORM__DOMAIN_WAVEFORM);
		...
		sandboxOperationsEClass = createEClass(SANDBOX_OPERATIONS);
		...
		attrSandboxOperationsEDataType = createEDataType(ATTR_SANDBOX_OPERATIONS);
		attrApplicationOperationsEDataType = createEDataType(ATTR_APPLICATION_OPERATIONS);
		attrDeviceManagerOperationsEDataType = createEDataType(ATTR_DEVICE_MANAGER_OPERATIONS);
	}
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(this.getSandbox());
		g1.getETypeArguments().add(g2);
		localScaEClass.getEGenericSuperTypes().add(g1);
		...
		g1 = createEGenericType(theScaPackage.getScaLoadableDevice());
		g2 = createEGenericType(theCfPackage.getLoadableDevice());
		g1.getETypeArguments().add(g2);
		...
		sandboxEClass.getESuperTypes().add(theCfPackage.getObject());
		sandboxEClass.getESuperTypes().add(theCfPackage.getIDLEntity());
		sandboxEClass.getESuperTypes().add(this.getSandboxOperations());

		// Initialize classes and features; add operations and parameters
		initEClass(localScaEClass, LocalSca.class, "LocalSca", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLocalSca_Waveforms(), this.getLocalScaWaveform(), null, "waveforms", null, 0, -1, LocalSca.class, IS_TRANSIENT, !IS_VOLATILE,
			IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLocalSca_SandboxWaveform(), this.getLocalScaWaveform(), null, "sandboxWaveform", null, 1, 1, LocalSca.class, IS_TRANSIENT,
		...
		initEClass(notifyingNamingContextEClass, NotifyingNamingContext.class, "NotifyingNamingContext", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNotifyingNamingContext_ObjectMap(), this.getNameToObjectEntry(), null, "objectMap", null, 0, -1, NotifyingNamingContext.class,
			IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNameToObjectEntry_Key(), this.getName_(), "key", null, 0, 1, Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
			!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNameToObjectEntry_Value(), theScaPackage.getObject(), "value", null, 0, 1, Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNameToNamingContextEntry_Key(), this.getName_(), "key", null, 0, 1, Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNameToNamingContextEntry_Value(), this.getNamingContext(), "value", null, 0, 1, Entry.class, !IS_TRANSIENT, !IS_VOLATILE,
			IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLocalScaWaveform_ComponentHost(), this.getLocalScaExecutableDevice(), null, "componentHost", null, 0, 1, LocalScaWaveform.class,
			IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLocalScaWaveform_ComponentHostDebug(), this.getLocalScaExecutableDevice(), null, "componentHostDebug", null, 0, 1,
			LocalScaWaveform.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
		...
		addEParameter(op, theScaPackage.getIProgressMonitor(), "monitor", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getLocalScaDeviceManager_NamingContext(), this.getNotifyingNamingContext(), null, "namingContext", null, 1, 1,
			LocalScaDeviceManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
		...
		initEClass(localScaLoadableDeviceEClass, LocalScaLoadableDevice.class, "LocalScaLoadableDevice", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(sandboxOperationsEClass, SandboxOperations.class, "SandboxOperations", IS_ABSTRACT, IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);
		...
		initEDataType(attrSandboxOperationsEDataType, SandboxOperations.class, "AttrSandboxOperations", !IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(attrApplicationOperationsEDataType, ApplicationOperations.class, "AttrApplicationOperations", !IS_SERIALIZABLE,
			!IS_GENERATED_INSTANCE_CLASS);
		initEDataType(attrDeviceManagerOperationsEDataType, DeviceManagerOperations.class, "AttrDeviceManagerOperations", !IS_SERIALIZABLE,
			!IS_GENERATED_INSTANCE_CLASS);
