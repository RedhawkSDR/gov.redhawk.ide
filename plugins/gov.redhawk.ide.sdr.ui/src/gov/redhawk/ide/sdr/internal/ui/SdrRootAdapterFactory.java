...
public class SdrRootAdapterFactory extends RedhawkUiAdapterFactory {
	...
	private class SdrRootPropertyDescriptor extends PropertyDescriptor {

		public SdrRootPropertyDescriptor(final Object object, final IItemPropertyDescriptor itemPropertyDescriptor) {
		...
		public CellEditor createPropertyEditor(final Composite composite) {
			...
			if (genericFeature != SdrPackage.Literals.SDR_ROOT__LOAD_STATUS) {
			...
			return new DialogCellEditor(composite) {
				...
				protected Object openDialogBox(final Control cellEditorWindow) {
					final IStatus status = ((SdrRoot) SdrRootPropertyDescriptor.this.object).getLoadStatus();
	...
	private class IdlLibraryPropertySource extends ScaPropertySource {
		...
		protected IPropertyDescriptor createPropertyDescriptor(final IItemPropertyDescriptor itemPropertyDescriptor) {
			return new SdrRootPropertyDescriptor(this.object, itemPropertyDescriptor);
		}
