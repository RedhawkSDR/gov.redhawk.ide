 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see gov.redhawk.ide.graphiti.dcd.ext.RHGDeviceGxFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='RHGDeviceGx' codeFormatting='true' modelPluginVariables='org.eclipse.xtext.xbase.lib' contentTypeIdentifier='http://www.redhawk.gov/model/rhdevicegext/1.0.0' operationReflection='false' modelDirectory='/gov.redhawk.ide.graphiti.dcd.ui/src' basePackage='gov.redhawk.ide.graphiti.dcd'"
 * @generated
 */
public interface RHGDeviceGxPackage extends EPackage {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	RHGDeviceGxPackage eINSTANCE = gov.redhawk.ide.graphiti.dcd.ext.impl.RHGDeviceGxPackageImpl.init();
	 ...
	 * @see gov.redhawk.ide.graphiti.dcd.ext.impl.RHGDeviceGxPackageImpl#getDeviceShape()
	 * @generated
	 */
	int DEVICE_SHAPE = 0;
	 ...
	 * @see gov.redhawk.ide.graphiti.dcd.ext.impl.RHGDeviceGxPackageImpl#getServiceShape()
	 * @generated
	 */
	int SERVICE_SHAPE = 1;
	 ...
	 * @generated
	 */
	RHGDeviceGxFactory getRHGDeviceGxFactory();
