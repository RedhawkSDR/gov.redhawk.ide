...
public class SADDefaultDeleteFeature extends DefaultDeleteFeature {

	public SADDefaultDeleteFeature(IFeatureProvider fp) {
		super(fp);
	}

	/**
	 * Determines the PictogramElement for which the delete context is being requested
	 * @param context
