...
import gov.redhawk.ide.sad.graphiti.ui.diagram.util.PropertyUtil;
import gov.redhawk.ide.sad.graphiti.ui.diagram.util.SaveUtil;
	...
	public PictogramElement add(IAddContext context) {
		...
		if(newComponentFile.eResource() == null){
			try{
				...
				SADUIGraphitiPlugin.getDefault().getLog().log(new Status(IStatus.ERROR, SADUIGraphitiPlugin.PLUGIN_ID, 
