...
public class RHContainerShapeImpl extends ContainerShapeImpl implements RHContainerShape
{
	...
	public final static String SHAPE_innerContainerShape = "innerContainerShape";
	...
	public final static int INNER_CONTAINER_SHAPE_HORIZONTAL_LEFT_PADDING = INNER_CONTAINER_SHAPE_HORIZONTAL_PADDING + PROVIDES_PORTS_LEFT_PADDING;
	...
	public final static int PORT_ROW_HEIGHT = 15;
	public final static int PORT_ROW_PADDING_HEIGHT = 5;
  ...
  public void init(final ContainerShape targetContainerShape, final String outerText, final List<EObject> businessObjects, 
		  final IFeatureProvider featureProvider, final String outerImageId, final Style outerContainerStyle, 
		  ...
		  int providesPortNameLength, IFeatureProvider featureProvider, Port externalPort)
  {
		...
		Graphiti.getPeService().setPropertyValue(providesPortContainerShape, DUtil.SHAPE_TYPE, SHAPE_providesPortContainerShape);//ref prevent selection/deletion/removal
		...
		Graphiti.getPeService().setPropertyValue(providesPortRectangleShape, DUtil.SHAPE_TYPE, SHAPE_providesPortRectangleShape);//ref prevent move
		  ...
		  IFeatureProvider featureProvider, List<Port> externalPorts)
  {
		...
		Graphiti.getGaLayoutService().setLocationAndSize(providesPortsRectangle, 
				PROVIDES_PORTS_LEFT_PADDING, PORTS_CONTAINER_SHAPE_TOP_PADDING, 
		  ...
		  IFeatureProvider featureProvider, Port externalPort)
  {
		...
		Graphiti.getGaLayoutService().setLocationAndSize(usesPortContainerShapeRectangle, usesPortsContainerShape.getGraphicsAlgorithm().getWidth()-(PORT_SHAPE_WIDTH + usesPortNameLength), iter++*(PORT_SHAPE_HEIGHT+5), PORT_SHAPE_WIDTH + usesPortNameLength, PORT_SHAPE_HEIGHT);
...
public EList<ProvidesPortStub> getInternalProvidesPortStubs()
  ...
  public static Port findExternalPort(Object portObject, List<Port> externalPorts){
	...
	public int getMinimumWidth(final String outerTitle, final String innerTitle, final EList<ProvidesPortStub> providesPortStubs, final EList<UsesPortStub> usesPortStubs){
		...
		int usesWidth = PORT_SHAPE_WIDTH + 
				DUtil.getLongestUsesPortWidth(usesPortStubs, diagram) +
