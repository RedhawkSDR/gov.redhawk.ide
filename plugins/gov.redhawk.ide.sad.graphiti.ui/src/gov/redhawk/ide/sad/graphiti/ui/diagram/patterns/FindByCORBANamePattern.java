...
public class FindByCORBANamePattern extends AbstractPattern implements IPattern{
	...
	public static final String NAME = "FindBy CORBA Name";
	...
	public boolean isMainBusinessObjectApplicable(Object mainBusinessObject) {
		return mainBusinessObject instanceof FindByStub;
	}
	@Override
	...
	public PictogramElement add(IAddContext context) {
		...
		DiagramUtil.addInnerRectangle(diagram,
				outerContainerShape,
				corbaNameText,
				getFeatureProvider(), ImageProvider.IMG_FIND_BY_NAMING_SERVICE,
		...
		areaContext.setSize(DiagramUtil.getPreferredWidth(corbaNameText, findByStub.getProvides(), findByStub.getUses()), DiagramUtil.getPreferredHeight(findByStub.getProvides(), findByStub.getUses()));
