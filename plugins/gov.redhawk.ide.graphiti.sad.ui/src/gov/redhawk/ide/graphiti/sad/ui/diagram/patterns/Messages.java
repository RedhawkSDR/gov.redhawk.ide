...
/* package */ class Messages extends NLS {
	...
	public static String UsesDevicePattern_CreateDescription;
	public static String UsesDevicePattern_CreateName;
	public static String UsesDevicePattern_EditName;
	static {
