...
public class FindByDomainManagerPattern extends AbstractFindByPattern implements IPattern {
	...
	public String getCreateName() {
		return Messages.FindByDomainManagerPattern_CreateName;
	}

	@Override
	public String getCreateDescription() {
		return Messages.FindByDomainManagerPattern_CreateDescription;
	}
	...
	public String getInnerTitle(FindByStub findByStub) {
		return Messages.FindByDomainManagerPattern_InnerTitle;
	}
