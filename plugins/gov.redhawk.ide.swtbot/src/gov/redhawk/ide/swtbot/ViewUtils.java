...
public class ViewUtils {
	...
	private static final String ALLOCATION_MGR_VIEW_ID = "gov.redhawk.ui.views.allocmgr.view";
	private static final String AUDIO_VIEW_ID = "gov.redhawk.ui.port.playaudio.view";
	private static final String CONNECTION_MGR_VIEW_ID = "gov.redhawk.ui.views.connmgr.view";
	...
	public static SWTBotView getAllocationManagerView(SWTWorkbenchBot bot) {
		return bot.viewById(ALLOCATION_MGR_VIEW_ID);
	}
	...
	public static SWTBotView getConnectionManagerView(SWTWorkbenchBot bot) {
		return bot.viewById(CONNECTION_MGR_VIEW_ID);
	}
	...
	public static SWTBotView getEventView(SWTWorkbenchBot bot) {
		return bot.viewById(EVENT_VIEW_ID);
	}
