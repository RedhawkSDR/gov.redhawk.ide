...
public class NewScaResourceProjectWizard extends NewScaResourceWizard implements IImportWizard {
	...
	@Override
    protected IFile createComponentFiles(IProject project, String projectID, String authorName, IProgressMonitor monitor) throws CoreException {
	    return ComponentProjectCreator.createComponentFiles(project, projectID, authorName, monitor);
    }
