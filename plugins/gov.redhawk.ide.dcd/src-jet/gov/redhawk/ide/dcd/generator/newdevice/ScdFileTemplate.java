...
public class ScdFileTemplate
{
  ...
  protected final String TEXT_9 = NL + "    <supportsinterface repid=\"IDL:CF/Device:1.0\" supportsname=\"Device\"/>" + NL + "    <supportsinterface repid=\"IDL:CF/Resource:1.0\" supportsname=\"Resource\"/>" + NL + "    <supportsinterface repid=\"IDL:CF/LifeCycle:1.0\" supportsname=\"LifeCycle\"/>" + NL + "    <supportsinterface repid=\"IDL:CF/PortSupplier:1.0\" supportsname=\"PortSupplier\"/>" + NL + "    <supportsinterface repid=\"IDL:CF/PropertySet:1.0\" supportsname=\"PropertySet\"/>" + NL + "    <supportsinterface repid=\"IDL:CF/TestableObject:1.0\" supportsname=\"TestableObject\"/>" + NL + "    <supportsinterface repid=\"IDL:CF/Logging:1.0\" supportsname=\"Logging\"/>" + NL + "    <supportsinterface repid=\"IDL:CF/LogEventConsumer:1.0\" supportsname=\"LogEventConsumer\"/>" + NL + "    <supportsinterface repid=\"IDL:CF/LogConfiguration:1.0\" supportsname=\"LogConfiguration\"/>" + NL + "    <ports/>" + NL + "  </componentfeatures>" + NL + "  <interfaces>";
  ...
  protected final String TEXT_12 = NL + "    <interface name=\"Device\" repid=\"IDL:CF/Device:1.0\">" + NL + "      <inheritsinterface repid=\"IDL:CF/Resource:1.0\"/>" + NL + "    </interface>" + NL + "    <interface name=\"Resource\" repid=\"IDL:CF/Resource:1.0\">" + NL + "      <inheritsinterface repid=\"IDL:CF/PropertySet:1.0\"/>" + NL + "      <inheritsinterface repid=\"IDL:CF/LifeCycle:1.0\"/>" + NL + "      <inheritsinterface repid=\"IDL:CF/PortSupplier:1.0\"/>" + NL + "      <inheritsinterface repid=\"IDL:CF/TestableObject:1.0\"/>" + NL + "      <inheritsinterface repid=\"IDL:CF/Logging:1.0\"/>" + NL + "    </interface>" + NL + "    <interface name=\"LifeCycle\" repid=\"IDL:CF/LifeCycle:1.0\"/>" + NL + "    <interface name=\"PortSupplier\" repid=\"IDL:CF/PortSupplier:1.0\"/>" + NL + "    <interface name=\"PropertySet\" repid=\"IDL:CF/PropertySet:1.0\"/>" + NL + "    <interface name=\"TestableObject\" repid=\"IDL:CF/TestableObject:1.0\"/>" + NL + "    <interface name=\"Logging\" repid=\"IDL:CF/Logging:1.0\">" + NL + "      <inheritsinterface repid=\"IDL:CF/LogEventConsumer:1.0\"/>" + NL + "      <inheritsinterface repid=\"IDL:CF/LogConfiguration:1.0\"/>" + NL + "    </interface>" + NL + "    <interface name=\"LogEventConsumer\" repid=\"IDL:CF/LogEventConsumer:1.0\"/>" + NL + "    <interface name=\"LogConfiguration\" repid=\"IDL:CF/LogConfiguration:1.0\"/>";
