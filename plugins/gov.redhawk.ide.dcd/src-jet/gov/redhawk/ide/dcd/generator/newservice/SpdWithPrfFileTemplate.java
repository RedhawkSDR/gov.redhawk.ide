...
public class SpdWithPrfFileTemplate
{
  protected static String nl;
  public static synchronized SpdWithPrfFileTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    SpdWithPrfFileTemplate result = new SpdWithPrfFileTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_6 = "\"/>" + NL + "  </descriptor>" + NL + "</softpkg>" + NL;
