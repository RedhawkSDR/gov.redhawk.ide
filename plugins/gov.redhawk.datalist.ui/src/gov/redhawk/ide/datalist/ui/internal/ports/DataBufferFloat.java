...
public class DataBufferFloat extends DataBuffer implements dataOctetOperations {

	@Override
	public void pushPacket(final byte[] data, final PrecisionUTCTime t, final boolean eos, final String streamID) {
	...
	public org.omg.CORBA.Object createRef(final POA poa) throws ServantNotActive, WrongPolicy {
		return poa.servant_to_reference(new dataOctetPOATie(this));
	}
