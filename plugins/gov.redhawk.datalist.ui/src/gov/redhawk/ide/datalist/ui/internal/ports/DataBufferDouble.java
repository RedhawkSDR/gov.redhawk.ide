...
public class DataBufferDouble extends DataBuffer implements dataDoubleOperations {

	@Override
	public void pushPacket(final double[] data, final PrecisionUTCTime time, final boolean eos, final String streamID) {
	...
	public org.omg.CORBA.Object createRef(final POA poa) throws ServantNotActive, WrongPolicy {
		return poa.servant_to_reference(new dataDoublePOATie(this));
	}
