 ...
 * </p>
 * <ul>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.TimeImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.TimeImpl#getEndTime <em>End Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeImpl extends EObjectImpl implements Time {
	...
	public void unsetStartTime() {
		...
		if (eNotificationRequired())
			eNotify(
				new ENotificationImpl(this, Notification.UNSET, SnapshotMetadataPackage.TIME__START_TIME, oldStartTime, START_TIME_EDEFAULT, oldStartTimeESet));
	}
