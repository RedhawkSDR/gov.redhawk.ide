...
import gov.redhawk.ide.internal.snapshot.metadata.KeywordsType;
import gov.redhawk.ide.internal.snapshot.metadata.Model;
...
import gov.redhawk.ide.internal.snapshot.metadata.StructSeq;
import gov.redhawk.ide.internal.snapshot.metadata.Time;
...
public class SnapshotMetadataPackageImpl extends EPackageImpl implements SnapshotMetadataPackage {
	 ...
	 * @see gov.redhawk.ide.internal.snapshot.metadata.SnapshotMetadataPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static SnapshotMetadataPackage init() {
		...
		SnapshotMetadataPackageImpl theSnapshotMetadataPackage = (SnapshotMetadataPackageImpl) (EPackage.Registry.INSTANCE.get(
			eNS_URI) instanceof SnapshotMetadataPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SnapshotMetadataPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getModel_NumberOfSamples(), theXMLTypePackage.getLong(), "numberOfSamples", null, 1, 1, Model.class, IS_TRANSIENT, IS_VOLATILE,
			IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getModel_DataByteOrder(), theXMLTypePackage.getString(), "dataByteOrder", "", 1, 1, Model.class, IS_TRANSIENT, IS_VOLATILE,
			IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEClass(sriEClass, gov.redhawk.ide.internal.snapshot.metadata.SRI.class, "SRI", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSRI_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Hversion(), theXMLTypePackage.getInt(), "hversion", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class,
			IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Xstart(), theXMLTypePackage.getDouble(), "xstart", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class, IS_TRANSIENT,
			IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Xdelta(), theXMLTypePackage.getDouble(), "xdelta", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class, IS_TRANSIENT,
			IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Xunits(), theXMLTypePackage.getShort(), "xunits", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class, IS_TRANSIENT,
			IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Subsize(), theXMLTypePackage.getDouble(), "subsize", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class,
			IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Ystart(), theXMLTypePackage.getDouble(), "ystart", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class, IS_TRANSIENT,
			IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Ydelta(), theXMLTypePackage.getDouble(), "ydelta", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class, IS_TRANSIENT,
			IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Yunits(), theXMLTypePackage.getShort(), "yunits", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class, IS_TRANSIENT,
			IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Mode(), theXMLTypePackage.getShort(), "mode", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class, IS_TRANSIENT,
			IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_StreamID(), theXMLTypePackage.getString(), "streamID", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class,
			IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSRI_Blocking(), theXMLTypePackage.getBoolean(), "blocking", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class,
			IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSRI_Keywords(), thePrfPackage.getProperties(), null, "keywords", null, 1, 1, gov.redhawk.ide.internal.snapshot.metadata.SRI.class,
		...
		initEAttribute(getStructSeq_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, StructSeq.class, !IS_TRANSIENT, !IS_VOLATILE,
			IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStructSeq_Struct(), this.getStruct(), null, "struct", null, 0, -1, StructSeq.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE,
			IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(structEClass, Struct.class, "Struct", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStruct_Id(), theXMLTypePackage.getString(), "id", null, 0, 1, Struct.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStruct_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, Struct.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSimple_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, Simple.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimple_Id(), theXMLTypePackage.getString(), "id", null, 1, 1, Simple.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimple_Value(), theXMLTypePackage.getString(), "value", null, 1, 1, Simple.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimple_JavaType(), theXMLTypePackage.getString(), "javaType", null, 1, 1, Simple.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(getModel_DataByteOrder(), source, new String[] { "kind", "element", "name", "dataByteOrder", "namespace", "##targetNamespace" });
		...
		addAnnotation(structSeqEClass, source, new String[] { "name", "StructSeq", "kind", "mixed" });
		addAnnotation(getStructSeq_Mixed(), source, new String[] { "kind", "elementWildcard", "name", "mixed" });
		addAnnotation(getStructSeq_Struct(), source, new String[] { "kind", "element", "name", "keywordStruct", "namespace", "##targetNamespace" });
		addAnnotation(structEClass, source, new String[] { "name", "Struct", "kind", "mixed" });
		addAnnotation(getStruct_Id(), source, new String[] { "kind", "attribute", "name", "id", "namespace", "##targetNamespace" });
		addAnnotation(getStruct_Mixed(), source, new String[] { "kind", "elementWildcard", "name", ":mixed" });
		addAnnotation(getStruct_Simple(), source, new String[] { "kind", "element", "name", "keywordSimple", "namespace", "##targetNamespace" });
		addAnnotation(simpleEClass, source, new String[] { "name", "simple", "kind", "mixed" });
		addAnnotation(getSimple_Mixed(), source, new String[] { "kind", "elementWildcard", "name", ":mixed" });
		addAnnotation(getSimple_Id(), source, new String[] { "kind", "element", "name", "id", "namespace", "##targetNamespace" });
		addAnnotation(getSimple_Value(), source, new String[] { "kind", "element", "name", "value", "namespace", "##targetNamespace" });
		addAnnotation(getSimple_JavaType(), source, new String[] { "kind", "element", "name", "javaType", "namespace", "##targetNamespace" });
	}
