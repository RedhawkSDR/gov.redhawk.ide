...
public class SnapshotMetadataFactoryImpl extends EFactoryImpl implements SnapshotMetadataFactory {
	...
	public static SnapshotMetadataFactory init() {
		try {
			SnapshotMetadataFactory theSnapshotMetadataFactory = (SnapshotMetadataFactory) EPackage.Registry.INSTANCE.getEFactory(
				SnapshotMetadataPackage.eNS_URI);
