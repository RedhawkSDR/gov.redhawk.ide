...
import gov.redhawk.ide.internal.snapshot.metadata.SRI;
 ...
 * </p>
 * <ul>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getHversion <em>Hversion</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getXstart <em>Xstart</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getXdelta <em>Xdelta</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getXunits <em>Xunits</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getSubsize <em>Subsize</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getYstart <em>Ystart</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getYdelta <em>Ydelta</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getYunits <em>Yunits</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getStreamID <em>Stream ID</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#isBlocking <em>Blocking</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.SRIImpl#getKeywords <em>Keywords</em>}</li>
 * </ul>
 *
 * @generated
 */
