 ...
 * </p>
 * <ul>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.ModelImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.ModelImpl#getNumberOfSamples <em>Number Of Samples</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.ModelImpl#getDataByteOrder <em>Data Byte Order</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.ModelImpl#getTime <em>Time</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.ModelImpl#getBulkIOType <em>Bulk IO Type</em>}</li>
 *   <li>{@link gov.redhawk.ide.internal.snapshot.metadata.impl.ModelImpl#getStreamSRI <em>Stream SRI</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends EObjectImpl implements Model {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case SnapshotMetadataPackage.MODEL__DATA_BYTE_ORDER:
