...
public class UBLUEDataReceiverClock extends SuperBLUEReceiver implements dataOctetOperations, 
    ...
    public UBLUEDataReceiverClock(File file, double time, BulkIOType type, 
