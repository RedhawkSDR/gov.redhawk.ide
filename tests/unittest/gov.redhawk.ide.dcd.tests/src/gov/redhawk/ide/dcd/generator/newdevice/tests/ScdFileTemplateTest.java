...
public class ScdFileTemplateTest {
	...
	private static final int EXE_SUPPORT_INTERFACE_COUNT = 13;
	private static final int EXE_INTERFACE_COUNT = 13;
	private static final int EXE_INHERITS_INTERFACE_COUNT = 12;

	private static final int LOAD_SUPPORT_INTERFACE_COUNT = 12;
	private static final int LOAD_INTERFACE_COUNT = 12;
	private static final int LOAD_INHERITS_INTERFACE_COUNT = 11;

	private static final int AGGREGATE_DEV_SUPPORT_INTERFACE_COUNT = 12;
	private static final int AGGREGATE_DEV_INTERFACE_COUNT = 12;
	private static final int AGGREGATE_DEV_INHERITS_INTERFACE_COUNT = 10;
