...
class component_i(component_base):
    ...
    def initialize(self):
        ...
        """
        component_base.initialize(self)
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", component_i.MyMsg, self.msg_callback)
