...
# Generated on: Mon Jun 03 17:06:26 EDT 2013
# REDHAWK IDE
# Version: 1.8.4
...
class ExamplePythonComponent_base(CF__POA.Resource, Resource):
...
class PortBULKIODataDoubleIn_i(ExamplePythonComponent_base.PortBULKIODataDoubleIn):
...
class PortBULKIODataFloatOut_i(ExamplePythonComponent_base.PortBULKIODataFloatOut):
    class linkStatistics:
        class statPoint:
            def __init__(self):
                self.elements = 0
