...
public class StubGeneratorDisplayFactory implements ICodegenDisplayFactory {

	@Override
	public ICodegenComposite createComposite(final Composite parent, final int style, final FormToolkit toolkit) {
		return new StubGeneratorPropertiesComposite(parent, style, toolkit);
	}

	@Override
	public ICodegenWizardPage createPage() {
		return new StubGeneratorPropertiesWizardPage();
	}
